...
- **Analysis:** `get_body_progress`, `get_training_summary` — see [docs/analysis-tools.md](docs/analysis-tools.md) for the integration guide (auth, output schemas, examples).
