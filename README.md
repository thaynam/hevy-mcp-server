...
- **Exercise templates/history:** `get_exercise_templates`, `get_exercise_template`, `search_exercise_templates`, `create_exercise_template`, `get_exercise_history`
...
- **Analysis:** `get_body_progress`, `get_training_summary`, `get_progression_deltas` — see [docs/analysis-tools.md](docs/analysis-tools.md) for the integration guide (auth, output schemas, examples).
